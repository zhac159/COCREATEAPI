...
export const AssetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiAssetDasdsaPut: async (id?: number, name?: string | null, description?: string | null, assetType?: AssetType, order?: number | null, cost?: number | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/Asset/dasdsa`;
...
export const AssetApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiAssetDasdsaPut(id?: number, name?: string | null, description?: string | null, assetType?: AssetType, order?: number | null, cost?: number | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiAssetDasdsaPut(id, name, description, assetType, order, cost, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AssetApi.apiAssetDasdsaPut']?.[index]?.url;
...
export const AssetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiAssetDasdsaPut(id?: number, name?: string | null, description?: string | null, assetType?: AssetType, order?: number | null, cost?: number | null, options?: any): AxiosPromise<void> {
            return localVarFp.apiAssetDasdsaPut(id, name, description, assetType, order, cost, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} id 
...
export class AssetApi extends BaseAPI {
     ...
     * @memberof AssetApi
     */
    public apiAssetDasdsaPut(id?: number, name?: string | null, description?: string | null, assetType?: AssetType, order?: number | null, cost?: number | null, options?: RawAxiosRequestConfig) {
        return AssetApiFp(this.configuration).apiAssetDasdsaPut(id, name, description, assetType, order, cost, options).then((request) => request(this.axios, this.basePath));
    }
